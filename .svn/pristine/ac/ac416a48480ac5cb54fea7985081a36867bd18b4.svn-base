...
[
	...
	{type: "TOLED", power_W: 1.7, current_A: 0, minVoltage_V: 15, icon: "TOLED.svg"},	
	{type: "SZOA", power_W: 1.7, current_A: 0, minVoltage_V: 15, icon: "SZOA.svg"},	
	{type: "Control V", power_W: 1.7, current_A: 0, minVoltage_V: 15, icon: "ControlV.svg"},	
];
